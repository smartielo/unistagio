  ...
  return (
    <Router>
      <Routes>
        ...
        {/* Passando o onLogout também para a página de dicas para o botão de sair funcionar lá */}
        ...
        <Route path="/admin" element={usuario?.tipo === 'admin' ? <Admin vagas={vagas} setVagas={setVagas} usuario={usuario} onLogout={handleLogout} /> : <Navigate to="/vagas" />} />
